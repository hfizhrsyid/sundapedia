    ...
    <>
      ...
      <div className="flex flex-col justify-center items-center my-10">
        ...
        <div className="flex flex-row flex-wrap justify-center gap-4">
          ...
          <Feature slug="pembelajaran" image={learningIcon} imageAlt={"Pembelajaran Bahasa"} description={"Pembelajaran Bahasa Sunda dilakukan secara bertahap dan disajikan secara interaktif dengan fitur-fitur yang ada!"} />
          <Feature slug="budaya" image={cultureIcon} imageAlt={"Pengenalan Budaya"} description={"Budaya juga dipelajari dengan pengenalan sejarah, kuliner, dan lainnya."} />
        </div>
      </div>
