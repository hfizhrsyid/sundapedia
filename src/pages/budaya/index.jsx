...
const BudayaCard = ({ title, image, bgColor, slug }) => (
  <div className={`rounded-lg overflow-hidden shadow border border-gray-300 w-60 ${bgColor}`}>
  ...
  return (
    <>
      ...
      <div className="p-8 text-center">
        ...
        <p className="mb-8">Pelajari lebih lanjut tentang budaya Sunda di halaman ini.</p>
        ...
        <div className="flex flex-wrap gap-5 justify-center">
          {filteredBudaya.length > 0 ? (
            ...
            <p className="text-gray-500 text-center">Budaya tidak ditemukan.</p>
          )}
        </div>
      </div>
    </>
