...
function PembelajaranAdmin() {
    ...
    const handleEditPart = async (courseId, part) => {
        ...
        window.location.href = `/admin/pembelajaran/${courseId}/${part.slug}`;
    };
                            ...
                            {course.parts && course.parts.filter(part => part.slug).map(part => (
                                <li key={part.id} className="mb-1 flex flex-col gap-1 border-b pb-2">
                                    ...
                                    <div className="flex items-center gap-2 mt-1">
                                        <Link
                                            to={`/admin/pembelajaran/${course.id}/${part.slug}`}
...
export default PembelajaranAdmin;